...
\section{Introduction to the import experiment}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{./images/putsRegionServer.png}
...
\subsubsection{First approach - second version : An HBase client without AutoFlush}
