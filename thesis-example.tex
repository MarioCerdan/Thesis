...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Scalability of a Cloud-Based Data Store:}
\newcommand{\SUBTITLE}{Improving HBase performance}
\newcommand{\DATE}{November 13, 2013}
...
% Other stuff
% ------------------------------------------------------------------
\newcommand{\PROFESSORSHIP}{Computer Science and Engineering}
% Professorship code is the same in all languages
\newcommand{\PROFCODE}{T-110}
\newcommand{\KEYWORDS}{Cloud-based, datastore, NoSQL, HBase, Hadoop, MapReduce, CAP,  Skew Data, YCSB}
...
This work would not have been completed without help and support of many individuals. I would like to thank to my supervisor Keijo Heljanko for providing me an opportunity to conduct my Thesis under his invaluable guidance and support over the course of it. 
I am grateful to Aalto University for giving me the chance of finishing my studies in Finland and for the opportunity of using Triton cluster for this Thesis. I would like also to thank to my roommates at Aalto: Bailo, Canellas and Guillermo for all the unforgettable moments we shared.
...
\input{9technicalBackground.tex}
