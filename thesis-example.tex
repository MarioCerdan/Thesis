...
\newcommand{\INSTRUCTOR}{Professor Keijo Heljanko}
...
\newcommand{\KEYWORDS}{cloud, datastore, HBase, Riak, Hadoop, Benchmarks}
...
Todo pruebas para ver si se usar Latex, comandos tipo fixme y demas
